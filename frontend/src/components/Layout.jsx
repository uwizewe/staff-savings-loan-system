...
const menu = [
  ...
  },
  {
    label: "Loans", icon: Landmark, roles: ["MEMBER", "INITIATOR", "APPROVER", "ADMIN"], children: [
      { label: "Loan applications", route: "loans?tab=applications" },
      { label: "Active loans", route: "loans?tab=active" },
      { label: "Loan repayments", route: "loans?tab=repayments" },
      { label: "Monthly repayments", route: "loans?tab=monthly", roles: ["INITIATOR", "APPROVER", "ADMIN"] },
    ],
  },
  {
  ...
  { label: "Reports", icon: FileBarChart, route: "reports", roles: ["INITIATOR", "APPROVER", "ADMIN"] },
  {
    label: "Administration", icon: Settings, roles: ["ADMIN"], children: [
      ...
      { label: "System settings", route: "admin?tab=settings" },
